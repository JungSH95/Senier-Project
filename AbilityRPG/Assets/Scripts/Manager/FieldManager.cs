...
public class FieldManager : Singleton<FieldManager>
{
    ...
    IEnumerator CoNextField()
    {
        ...
        nowField.GetComponent<SpawnManager>().SpawnStart();

        // 몬스터 생성이 끝날때까지 대기
        while(nowField.GetComponent<SpawnManager>().isSpawnEnd != true)
        {
            Debug.Log(nowField.name);
        ...
        fadeManager.FadeIn();
        nowField.GetComponent<SpawnManager>().MonsterAllSetActive();
    }
}
